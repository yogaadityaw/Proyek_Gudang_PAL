                            ...
                            <form method="post">
                                ...
                                <div class="form-row mt-2">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="nip" id="nip" placeholder="NIP" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <label for="disabledTextInput">Nama Barang</label>
                                    <input type="text" class="form-control" name="namabarang" id="namabarang" placeholder="Nama Barang" disabled>
                                </div>
                                <div class="form-row">
                                    <label for="disabledTextInput">Kode Barang</label>
                                    <input type="text" class="form-control" name="kodebarang" id="kodebarang" placeholder="Kode Barang" disabled>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Jumlah Barang yang dipinjam</label>
                                        <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah Barang" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="lokasikembali" id="lokasikembali" placeholder="Lokasi Barang yang dikembalikan" disabled>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="kodepinjam" name="kodepinjam" disabled>
                                        </div>
                                    </div>
                                    <br>
